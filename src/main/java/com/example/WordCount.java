...
public class WordCount {
    ...
    public void processElement(ProcessContext c) {
      ...
      for (String word : words) {
        if (!word.isEmpty()) {
          ...
          System.out.println("Test Port 3000");
          testPort("10.128.0.8", 3000);
        }
      }
    }

    public void testPort(String host, int port) {
      Socket s = null;
      try {
          s = new Socket();
          ...
          s.connect(sa, 3000);
          System.out.println("Connected successfully 3000");
          return;
      } catch (IOException e) {
          e.printStackTrace();
      } finally {
  ...
  public static class CountWords extends PTransform<PCollection<String>,
    ...
    public PCollection<KV<String, Long>> expand(PCollection<String> lines) {
      ...
      try {
        //URL u = new URL("http://10.128.0.3/kinglear.txt");
